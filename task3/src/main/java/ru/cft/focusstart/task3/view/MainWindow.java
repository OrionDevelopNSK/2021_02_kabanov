...
public class MainWindow extends JFrame implements MainWindowInterface {
    ...
    private JPanel createButtonsPanel(int numberOfRows, int numberOfCols) {
        ...
        final boolean[] isLeftButtonPressed = {false};
        final boolean[] isRightButtonPressed = {false};
            ...
            for (int col = 0; col < numberOfCols; col++) {
                ...
                cellButtons[y][x].addMouseListener(new MouseAdapter() {
                    ...
                    public void mousePressed(MouseEvent e) {
                        if (e.getButton() == MouseEvent.BUTTON1) isLeftButtonPressed[0] = true;
                        if (e.getButton() == MouseEvent.BUTTON3) isRightButtonPressed[0] = true;
                        if (isLeftButtonPressed[0] && isRightButtonPressed[0]){
                    ...
                    public void mouseReleased(MouseEvent e) {
                        if (e.getButton() == MouseEvent.BUTTON1) isLeftButtonPressed[0] = false;
                        if (e.getButton() == MouseEvent.BUTTON3) isRightButtonPressed[0] = false;
                        if (listener == null) {
                            return;
                        }

                        //  изменены MIDDLE и RIGHT между собой, не корректно срабатывали
                        switch (e.getButton()) {
